...
**a)** Rename confounds tsv files generated by fmriprep for compatibility with NiBetaseries that will use the confounds tsv files to obtain single trial estimates
```
