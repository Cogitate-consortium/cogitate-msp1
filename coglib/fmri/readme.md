...
**a)** Resolve compatibility issues between fmriprep/20.2.3 and nibetaseries/0.6.0 that will be used to obtain single trial estimates 
...
Alternatively, use the dataset_description.json located in the sample dataset dir. This file has been modified as described above.
