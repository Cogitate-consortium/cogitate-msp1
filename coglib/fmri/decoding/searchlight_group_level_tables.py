# Generates ROI tables based on category and orientation searchlight group-level maps
...
output_fname_pattern_cvs = output_dir + '/searchlight_group_level_table.csv'
...
input_nifti= os.path.join(data_dir, 'searchlight_group_accuracy_map_nonparametric.nii')
