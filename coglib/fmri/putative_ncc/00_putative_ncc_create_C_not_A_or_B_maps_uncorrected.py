...
# -*- coding: utf-8 -*-
"""
Takes C conjunction uncorrected maps and excludes voxels that are included either
in an A uncorrected conjunction or a B uncorrected conjunction.
...
if __name__ == '__main__':
    ...
    conjunction_names = ['C_combined_and_uncorrected_Activation_conjunction',
                         'C_combined_and_uncorrected_Deactivation_conjunction',
                         'C_combined_or_uncorrected_Activation_conjunction',
                         'C_combined_or_uncorrected_Deactivation_conjunction',
                         'C_combined_sum_uncorrected_Activation_conjunction',
                         'C_combined_sum_uncorrected_Deactivation_conjunction',
                         'C_Face_uncorrected_conjunction',
                         'C_FalseFont_uncorrected_conjunction',
                         'C_Letter_uncorrected_conjunction',
                         'C_Object_uncorrected_conjunction',
                         'C_Face_uncorrected_Activation_conjunction',
                         'C_FalseFont_uncorrected_Activation_conjunction',
                         'C_Letter_uncorrected_Activation_conjunction',
                         'C_Object_uncorrected_Activation_conjunction',
                         'C_Face_uncorrected_Deactivation_conjunction',
                         'C_FalseFont_uncorrected_Deactivation_conjunction',
                         'C_Letter_uncorrected_Deactivation_conjunction',
                         'C_Object_uncorrected_Deactivation_conjunction']
    
    A = np.squeeze(load_mri(data_dir + os.sep + 'A_uncorrected_conjunction.nii.gz', group_mask))
    B = np.squeeze(load_mri(data_dir + os.sep + 'B_uncorrected_conjunction.nii.gz', group_mask))
