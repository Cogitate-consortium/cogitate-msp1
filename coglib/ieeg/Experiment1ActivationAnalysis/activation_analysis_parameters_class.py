"""Handle parameters for duration analysis."""
...
class DurationAnalysisParameters:
    """
    ...
    def __init__(self, json_file, sub_id=None):
        ...
        self.figures_root = json_dict['fig_root']
        ...
        self.files_prefix = "sub-" + self.SUBJ_ID + "_ses-" + self.session + "_task-" + self.task_name \
                            + "_ana-activation_analysis_"

        # Instantiating the directory to save the data:
        self.save_root = str(Path(self.BIDS_root, "derivatives", "activation_analysis", "sub-" + self.SUBJ_ID,
